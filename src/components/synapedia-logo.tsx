...
export function SynapediaLogo({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="9" cy="16" r="2" fill="currentColor" className="brand-twinkle" />
      <circle cx="23" cy="16" r="2" fill="currentColor" className="brand-twinkle" style={{ animationDelay: "1.5s" }} />
      <circle cx="16" cy="25" r="2.2" fill="currentColor" opacity="0.85" />

      {/* Subtle outer accent dots */}
      <circle cx="5" cy="10" r="1" fill="currentColor" className="brand-twinkle" style={{ animationDelay: "2.5s" }} />
      <circle cx="27" cy="10" r="1" fill="currentColor" className="brand-twinkle" style={{ animationDelay: "3.2s" }} />
